...
namespace pro_view.fld_PL.fld_Accounting.fld_Settings
{
    public partial class frm_chart : Form
    {
        ...
        pro_view.fld_BL.cls_bl.stc_Accounting.stc_Settings.stc_chart module = new fld_BL.cls_bl.stc_Accounting.stc_Settings.stc_chart();
        ...
        private void frm_G_Shown(object sender, EventArgs e)
        {
            ...
            com_list_id.DataSource = ds.Tables["tbl_chartlists"];
            com_list_id.ValueMember = "id";
            com_list_id.DisplayMember = "aname";
            com_list_id.SelectedValue = -1;

            com_side_id.DataSource = ds.Tables["tbl_chartside"];
            com_side_id.ValueMember = "id";
            com_side_id.DisplayMember = "aname";
            com_side_id.SelectedValue = -1;

            com_ccrelation_id.DataSource = ds.Tables["tbl_chartccrelation"];
            com_ccrelation_id.ValueMember = "id";
            com_ccrelation_id.DisplayMember = "aname";
            com_ccrelation_id.SelectedValue = -1;

            com_prop_id.DataSource = ds.Tables["tbl_chartprop"];
            com_prop_id.ValueMember = "id";
            com_prop_id.DisplayMember = "aname";
            com_prop_id.SelectedValue = -1;
        ...
        void Form_Mode(string mode)
        {
            switch (mode)
            {
                ...
                case "New":
                    ...
                    com_list_id.SelectedValue = list_id != "" ? list_id : "1";
                    com_side_id.SelectedValue = side_id != "" ? side_id : "1";
                    com_ccrelation_id.SelectedValue = ccrelation_id != "" ? ccrelation_id : "1";
                ...
                case "Select":
                    ...
                    foreach (DataRow r in ds.Tables[0].Rows)
                    {
                        if (r["id"].ToString() == dgv.CurrentCell.Value.ToString())
                        {
                            ...
                            com_list_id.SelectedValue = r["menue_id"].ToString();
                            com_side_id.SelectedValue = r["side_id"].ToString();
                            com_ccrelation_id.SelectedValue = r["ccrelation_id"].ToString();
                            com_cc1_id.SelectedValue = r["cc1_id"].ToString();
                            com_cc2_id.SelectedValue = r["cc2_id"].ToString();
                            com_prop_id.SelectedValue = r["property_id"].ToString();
                            ...
                            list_id = (com_list_id.SelectedValue != null) ? com_list_id.SelectedValue.ToString() : "";
                            side_id = (com_side_id.SelectedValue != null) ? com_side_id.SelectedValue.ToString() : "";
                            ccrelation_id = (com_ccrelation_id.SelectedValue != null) ? com_ccrelation_id.SelectedValue.ToString() : "";
        ...
        void Bind()
        {
            ...
            module.menue_id = (com_list_id.SelectedValue != null) ? com_list_id.SelectedValue.ToString() : null;
            module.side_id = (com_side_id.SelectedValue != null) ? com_side_id.SelectedValue.ToString() : null;
            module.ccrelation_id = (com_ccrelation_id.SelectedValue != null) ? com_ccrelation_id.SelectedValue.ToString() : null;
            module.cc1_id = (com_cc1_id.SelectedValue != null) ? com_cc1_id.SelectedValue.ToString() : null;
            module.cc2_id = (com_cc2_id.SelectedValue != null) ? com_cc2_id.SelectedValue.ToString() : null;
            module.property_id = (com_prop_id.SelectedValue != null) ? com_prop_id.SelectedValue.ToString() : null;
        ...
        void Refresh_Data()
        {
            ...
            dt = ds.Tables["tbl_chart"].Clone();
            foreach (DataRow dr in ds.Tables["tbl_chart"].Rows)
            {
                dt.Rows.Add(dr.ItemArray);
            }
            dt.DefaultView.RowFilter = (ParentID.Count == 0) ? "parent_id is null" : "parent_id = " + ParentID[ParentID.Count - 1];
        ...
        {
            if (!frm_main.Perm("0209002"))
            {
                MessageBox.Show("ليس لديك تصريح لاضافة حساب جديد", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        {
            if (!frm_main.Perm("0209003"))
            {
                MessageBox.Show("ليس لديك تصريح لتعديل حساب", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "Edit";
            Form_Mode("Edit");
        ...
        {
            if (!frm_main.Perm("0209004"))
            {
                MessageBox.Show("ليس لديك تصريح لحذف حساب", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void btn_UP_Click(object sender, EventArgs e)
        {
            if (level == 2)
            {
                ...
                dt.DefaultView.RowFilter = "parent_id IS NULL";
            ...
            else if (level > 2)
            {
                ...
                dt.DefaultView.RowFilter = "parent_id = " + ParentID[ParentID.Count - 1];
                foreach (DataGridViewRow r in dgv.Rows)
                {
                    if (r.Cells[0].Value.ToString() == i)
                    {
        ...
        private void dgv_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(Convert.ToInt32(dgv.CurrentRow.Cells["used"].Value) > 0)
            {
                MessageBox.Show("الحساب مستخدم ولايمكن التفرع منه", "دليل الحسابات", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
