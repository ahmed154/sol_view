...
{
    public partial class frm_Rows : Form
    {
        #region Declarations
        public pro_view.fld_PL.fld_Login.frm_main frm_main;
        pro_view.fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_rows module = new fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_rows();
