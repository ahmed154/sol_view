...
{
    public partial class frm_Scl_Stages : Form
    {
        #region Declarations
        public pro_view.fld_PL.fld_Login.frm_main frm_main;
        pro_view.fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_stages module = new fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_stages();
        DataSet ds = new DataSet();
        int record_index;
        #endregion

        public frm_Scl_Stages()
        {
            InitializeComponent();
