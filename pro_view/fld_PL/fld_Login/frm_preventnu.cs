...
{
    public partial class frm_preventnu : Form
    {
        #region Declarations
        ...
        private void btn_Run_Click(object sender, EventArgs e)
        {
            ...
            {
                string i = Encrypt(id);
                Properties.Settings.Default.PreventID = i;
                Properties.Settings.Default.PreventDays = Encrypt(ExpireDate(AddDays));
                //Properties.Settings.Default.LoginUser = UserID;
                Properties.Settings.Default.Save();

                Hide();

                Application.Exit();
                frm_main.com_users.SelectedValue = UserID;
                frm_main.Show();
            }
            else
            {
