...
namespace pro_view.fld_PL.fld_General_Settings
{
    public partial class frm_cities : Form
    {
        ...
        pro_view.fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_cities module = new fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_cities();
        ...
        public frm_cities()
        {
            ...
            Refresh_Data();
            com_country_id.DataSource = ds.Tables["tbl_nationality"];
            com_country_id.ValueMember = "id";
            com_country_id.DisplayMember = "aname";
        ...
        void Bind()
        {
            ...
            module.country_id = com_country_id.SelectedValue.ToString();
        }
        void ClearForm()
        {
                ...
                case "Select":
                    ...
                    foreach (DataRow r in ds.Tables[0].Rows)
                    {
                        if (r["ID"].ToString() == dgv.SelectedRows[0].Cells[0].Value.ToString())
                        {
                            ...
                            com_country_id.SelectedValue = r["country_id"].ToString();
