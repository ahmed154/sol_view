...
namespace pro_view.fld_PL.fld_General_Settings
{
    public partial class frm_currencies : Form
    {
        ...
        void Bind()
        {
            ...
            module.price = (txt_price.Text.Trim() != "") ? Convert.ToDecimal(txt_price.Text.Trim()) : 1;
        ...
        {
            if (!frm_main.Perm("0105002"))
            {
                MessageBox.Show("ليس لديك تصريح لاضافة عملة جديدة", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "New";
            Form_Mode("New");
        ...
        {
            if (!frm_main.Perm("0105003"))
            {
                MessageBox.Show("ليس لديك لتعديل بيانات عملة", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "Edit";
            Form_Mode("Edit");
        ...
        {
            if (!frm_main.Perm("0105004"))
            {
                MessageBox.Show("ليس لديك تصريح لحذف عملة", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
