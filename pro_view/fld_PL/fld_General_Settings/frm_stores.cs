...
namespace pro_view.fld_PL.fld_General_Settings
{
    public partial class frm_stores : Form
    {
        ...
        pro_view.fld_BL.cls_bl.stc_General_Settings.stc_stores module = new fld_BL.cls_bl.stc_General_Settings.stc_stores();
        ...
        void Form_Mode(string mode)
        {
            switch (mode)
            {
                ...
                case "New":
                    ...
                    com_branch_id.Enabled = false;
                    txt_aname.Focus();
                    com_company_id.SelectedValue = frm_main.com_companies.SelectedValue.ToString();
                    com_branch_id.SelectedValue = frm_main.com_branches.SelectedValue.ToString();
                    break;
                #endregion
        ...
        void Bind()
        {
            ...
            module.responame = txt_responame.Text.Trim();
        ...
        {
            if (!frm_main.Perm("0102002"))
            {
                MessageBox.Show("ليس لديك تصريح لاضافة مستودع جديد", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "New";
            Form_Mode("New");
        ...
        {
            if (!frm_main.Perm("0102003"))
            {
                MessageBox.Show("ليس لديك تصريح لتعديل بيانات مستودع", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "Edit";
            Form_Mode("Edit");
        ...
        {
            if (!frm_main.Perm("0102004"))
            {
                MessageBox.Show("ليس لديك تصريح لحذف مستودع", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
