...
namespace pro_view.fld_PL.fld_General_Settings
{
    public partial class frm_areas : Form
    {
        ...
        pro_view.fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_areas module = new fld_BL.fld_School.fld_General_Setting.cls_General_Setting.stc_areas();
        ...
        public frm_areas()
        {
            ...
            Refresh_Data();
            com_city_id.DataSource = ds.Tables["tbl_cities"];
            com_city_id.ValueMember = "id";
            com_city_id.DisplayMember = "aname";
        ...
        void Bind()
        {
            ...
            module.city_id = com_city_id.SelectedValue.ToString();
        }
        void ClearForm()
        {
                ...
                case "Select":
                    ...
                    foreach (DataRow r in ds.Tables[0].Rows)
                    {
                        if (r["ID"].ToString() == dgv.SelectedRows[0].Cells[0].Value.ToString())
                        {
                            ...
                            com_city_id.SelectedValue = r["city_id"].ToString();
