...
namespace pro_view.fld_PL.fld_General_Settings
{
    public partial class frm_fyears : Form
    {
        ...
        {
            if (!frm_main.Perm("0103002"))
            {
                MessageBox.Show("ليس لديك تصريح لاضافة سنة مالية جديدة", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "New";
            Form_Mode("New");
        ...
        {
            if (!frm_main.Perm("0103003"))
            {
                MessageBox.Show("ليس لديك تصريح لتعديل بيانات سنة مالية", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            Tag = "Edit";
            Form_Mode("Edit");
        ...
        {
            if (!frm_main.Perm("0103004"))
            {
                MessageBox.Show("ليس لديك تصريح لحذف سنة مالية", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        {
            txt_beigndate.Text = dtp_begindate.Value.ToString("dd/MM/yyyy");
        }

        private void dtp_enddate_ValueChanged(object sender, EventArgs e)
        {
            txt_enddate.Text = dtp_enddate.Value.ToString("dd/MM/yyyy");
        }
    }
}
